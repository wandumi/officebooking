...
const deletehelpdesk = () => {
    if (helpdeskToDelete.value) {
        router.delete(route('admin.help-desk.destroy', helpdeskToDelete.value), {
            preserveScroll: true,
            onSuccess: () => {
                successMessage.value = 'A Help Desk has been deleted successfully.';
                window.scrollTo({ top: 0, behavior: 'smooth' });
            },
            onFinish: () => {
                ...
                <div class="p-2">
                    ...
                    <div class="flex flex-col gap-3 mb-4 sm:flex-row sm:items-center sm:justify-between">
                        <Link
                            ...
                            class="inline-block px-3 py-1 text-sm font-medium text-white rounded bg-primary hover:bg-bluemain/60">
                            + Add Hot Desk
                        </Link>
                        <div></div>
                        ...
                        <table class="min-w-full border border-gray-300 divide-y divide-gray-200">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-sm font-medium text-left text-gray-700">Duration</th>
                                    <th class="px-6 py-3 text-sm font-medium text-left text-gray-700">Desks</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr
                                    ...
                                    :key="helpdesk.id">
                                    <td class="px-6 py-4 text-sm text-gray-800">{{ helpdesk.id }}</td>
